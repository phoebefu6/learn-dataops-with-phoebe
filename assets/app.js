...
(function () {
  ...
  /* Journey strip: you-are-here (leader track of 6, builder track of 8) */
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Builder session (\d+) of 8/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-why-dataops.html", "a2-four-pillars.html", "a3-maturity-model.html",
           "a4-build-buy-oss.html", "a5-org-and-culture.html", "a6-roi-and-roadmap.html"]
        : ["b1-foundations-repo.html", "b2-orchestration.html", "b3-data-testing-contracts.html",
           "b4-dbops-migrations.html", "b5-experiment-tracking.html", "b6-model-deploy-monitor.html",
           "b7-observability-iac.html", "b8-full-cd-capstone.html"];
